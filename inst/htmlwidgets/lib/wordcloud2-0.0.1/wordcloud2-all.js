...
(function (global) {
  ...
  var WordCloud = function WordCloud (elements, options) {
    ...
    switch (settings.color) {
      ...
      case 'random-carto-bold':
        getTextColor = function getRandomCartoBoldColor () {
          const palette = [
            "#7F3C8D", "#11A579", "#3969AC", "#F2B701", "#E73F74", "#80BA5A",
            "#E68310", "#008695", "#CF1C90", "#f97b72", "#4b4b8f", "#A5AA99"
          ];
          const random = Math.floor(Math.random() * palette.length);
          return palette[random]
        }
        break


      case 'random-carto-prism':
        getTextColor = function getRandomCartoPrismColor () {
          const palette = [
      ...
      case 'random-carto-sunset-dark':
        getTextColor = function getRandomSunsetDarkColor () {
          const palette = [
            /*"#fcde9c",*/
      ...
      case 'random-jlu-blue':
        getTextColor = function getRandomJLUBlueColor () {
          const palette = [
            "#7CADF2", "#6FA3E7", "#6299DC", "#568FD2", "#4985C7", "#3C7CBC",
            "#3072B2", "#2368A7", "#165E9C", "#0A5592"
          ];
          const random = Math.floor(Math.random() * palette.length);
          return palette[random]
        }
      ...
      /*
      case 'random-mine':
        getTextColor = function getRandomMineColor (word, weight, fontSize, distance, theta) {
          import word_color from "/home/moritz/Documents/wordcloud/word_color.json";
          return word_color[word]
        }
        break
      */
